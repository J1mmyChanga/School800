...
g1 = Groups(title='Новаторы: Нео', rating=4464)
g2 = Groups(title='Инженеры: Класт', rating=6879)
g3 = Groups(title='Аналитики: Трейл', rating=2234)
g4 = Groups(title='Исследователи: Скрипт', rating=2868)
for i in range(1, 5):
...
t1 = Tasks(task='Полить цветы на школьной территории',
           kind=7, daily=True, difficulty=1, individual=True, start=date(year=2024, month=3, day=1), end=date(year=2024, month=3, day=2))
t2 = Tasks(task='Подмести и вымыть пол на школьной площадке',
           kind=7, daily=False, difficulty=2, individual=False, start=date(year=2024, month=3, day=7), end=date(year=2024, month=3, day=14))
t3 = Tasks(task='Провести исследование и написать отчёт о том, какие виды растений лучше всего подходят для обустройства школьного двора',
           kind=2, daily=False, difficulty=3, individual=True, start=date(year=2024, month=3, day=1), end=date(year=2024, month=3, day=15))
t4 = Tasks(task='Провести уборку столовой после завтрака',
           kind=7, daily=True, difficulty=2, individual=True, start=date(year=2024, month=3, day=8), end=date(year=2024, month=3, day=9))
t5 = Tasks(task='Подготовить и провести урок в рамках школьного кружка или клуба',
           kind=2, daily=False, difficulty=3, individual=True, start=date(year=2024, month=5, day=9), end=date(year=2024, month=5, day=23))
t6 = Tasks(task='Организовать и провести спортивный турнир по воллейболу среди учеников',
           kind=1, daily=False, difficulty=2, individual=False, start=date(year=2024, month=4, day=1), end=date(year=2024, month=4, day=30))
t7 = Tasks(task='Посадить дерево на территории школы',
           kind=4, daily=True, difficulty=3, individual=True, start=date(year=2024, month=4, day=1), end=date(year=2024, month=4, day=2))
t8 = Tasks(task='Помочь учителю подготовить материалы для урока',
           kind=2, daily=True, difficulty=2, individual=True, start=date(year=2024, month=3, day=1), end=date(year=2024, month=3, day=2))
t9 = Tasks(task='Провести анализ использования энергии в школьном здании и предложить меры по её экономии',
           kind=2, daily=False, difficulty=3, individual=False, start=date(year=2024, month=2, day=1), end=date(year=2024, month=2, day=23))
t10 = Tasks(task='Провести исследование о вреде курения среди школьников и представить результаты на школьной конференции',
           kind=2, daily=False, difficulty=3, individual=False, start=date(year=2024, month=1, day=1), end=date(year=2024, month=1, day=30))

t11 = Tasks(task='Помочь в организации и проведении школьного праздника',
           kind=5, daily=True, difficulty=2, individual=True, start=date(year=2024, month=4, day=1), end=date(year=2024, month=4, day=2))
t12 = Tasks(task='Помочь ученику с домашним заданием или подготовкой к контрольной работе',
           kind=5, daily=False, difficulty=1, individual=True, start=date(year=2024, month=3, day=7), end=date(year=2024, month=3, day=14))
t13 = Tasks(task='Провести мастер-класс по изучаемому предмету для младших школьников',
           kind=6, daily=False, difficulty=2, individual=True, start=date(year=2024, month=2, day=1), end=date(year=2024, month=2, day=20))
t14 = Tasks(task='Организовать сбор вторсырья для переработки на благотворительный фонд',
           kind=4, daily=False, difficulty=2, individual=False, start=date(year=2024, month=3, day=8), end=date(year=2024, month=3, day=25))
t15 = Tasks(task='Помочь ученику с трудностями в обучении',
           kind=5, daily=True, difficulty=2, individual=True, start=date(year=2024, month=5, day=9), end=date(year=2024, month=5, day=10))
t16 = Tasks(task='Провести исследование о влиянии социальных сетей на молодежь и подготовить презентацию результатов',
           kind=2, daily=False, difficulty=3, individual=False, start=date(year=2024, month=4, day=1), end=date(year=2024, month=4, day=30))
t17 = Tasks(task='Принять участие в экологической акции по уборке мусора на улицах района',
           kind=4, daily=False, difficulty=2, individual=False, start=date(year=2024, month=4, day=1), end=date(year=2024, month=4, day=15))
t18 = Tasks(task='Помочь библиотекарю организовать книжный уголок в классе',
           kind=2, daily=False, difficulty=1, individual=True, start=date(year=2024, month=3, day=1), end=date(year=2024, month=3, day=7))
t19 = Tasks(task='Участвовать в работе школьного интернет-журнала: писать статьи, делиться новостями',
           kind=2, daily=False, difficulty=3, individual=False, start=date(year=2024, month=2, day=1), end=date(year=2024, month=4, day=2))
t20 = Tasks(task='Провести анкетирование среди учеников по теме предпочтений в образовательном процессе и анализировать полученные данные',
           kind=2, daily=False, difficulty=3, individual=False, start=date(year=2024, month=1, day=8), end=date(year=2024, month=1, day=16))
